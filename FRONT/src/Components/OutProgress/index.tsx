	...
	return (
		<article className={`main__header-progress ${PathDisplay}`}>
			...
			<div className="progressCard">
				...
				<img src={`/kvd/assets/img/6K6Z89WII3L01693945700775.png`} alt="" />
			</div>
			<div className="progressCard">
				...
				<img src={`/kvd/assets/img/FpaAUhx.jpg`} alt="" />
			</div>
			<div className="progressCard">
				...
				<img src={`/kvd/assets/img/Raid-Finder-Wing-2-Vault-of-the-Incarnates.jpg`} alt="" />
			</div>
		</article>
	);
}
